...
from Lib import helper_generic as hlp
from Lib import helper_site_response as sr
from Lib import helper_simulations as sim
from Lib import helper_signal_processing as sig

from Lib.class_ground_motion import Ground_Motion
from Lib.class_Vs_profile import Vs_Profile
from Lib.class_parameters import Param_Multi_Layer
from Lib.class_curves import Multiple_GGmax_Damping_Curves
from Lib.class_simulation_results import Simulation_Results
from Lib.class_frequency_spectrum import Frequency_Spectrum
...
class Nonlinear_Simulation(Simulation):
    ...
    def run(
        ...
        dir_exec_files = os.path.join('Lib','exec_files')
        ...
        os.chdir(sim_dir)
        if hlp.detect_OS() == 'Windows':
            subprocess.run('NLHH.exe',stdout=True)
        elif hlp.detect_OS() == 'Darwin':
